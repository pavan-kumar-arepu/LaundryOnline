...
struct TicketView: View {
    @ObservedRealmObject var ticket: TicketModel
...
struct TicketView_Previews: PreviewProvider {
    static var previews: some View {
        let ticket1 = TicketModel(reportedBy: "Andrew", product: "Realm", title: "My big issue", problemDescription: "This is a big deal")
        let ticket2 = TicketModel(reportedBy: "Andrew", product: "Realm", title: "My second issue")
        ticket2.status = .inProgress
        let ticket3 = TicketModel(reportedBy: "Andrew", product: "Realm", title: "Issue three", problemDescription: "This is not such a big deal. But I do want to talk about it at greate length. This is not such a big deal. But I do want to talk about it at greate length.")
